 ...
 * <p>
 * The default implementation marks the query terms as bold, and places ellipses
 * between unconnected passages.
 */
public class OffsetPassageFormatter extends PassageFormatter {
	 ...
	 */
	public OffsetPassageFormatter(String preTag, String postTag, String ellipsis, boolean escape) {
